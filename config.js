...
module.exports = {
    VERSION: 'V 2.0.1',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/KCnoMM2.jpg Hey {sender}, I'd rather be dead than alive master",
    ...
    BOT_NAME: process.env.BOT_NAME || 'Zoid',
    ...
    SUDO: process.env.SUDO || '27783320433,0',
